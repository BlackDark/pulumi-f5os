...
namespace Pulumi.F5os.Inputs
{
    ...
    public sealed class LoggingServerArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("logs")]
        private InputList<Inputs.LoggingServerLogArgs>? _logs;

        /// <summary>
        /// Log selectors for this server, specifying facility and severity.
        /// </summary>
        public InputList<Inputs.LoggingServerLogArgs> Logs
        {
            get => _logs ?? (_logs = new InputList<Inputs.LoggingServerLogArgs>());
            set => _logs = value;
        }
