...
namespace Pulumi.F5os
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.F5os.version.txt");
    ...
    internal sealed class F5osResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public F5osResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
